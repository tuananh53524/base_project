            ...
            <span class="input-group-prepend">
              <label class="input-group-text" for="dataScaleY">ScaleY</label>
                ...
                <div class="form-check">
                    <input type="checkbox" id="keep-aspect-ratio" class="form-check-input" checked>
                    <label class="form-check-label" for="defaultCheck1">
                        Keep aspect ratio
                    </label>
                </div>
                <div class="form-check">
                    <input type="checkbox" id="allow-upscaling" class="form-check-input" checked>
                ...
                <div class="input-group input-group-sm mt-2">
                    <a href="javascript:void(0)" data-role="crop" class="btn btn-danger submit-crop mr-3">Crop</a>
                    <a href="javascript:void(0)" data-role="resize" class="btn btn-info submit-crop">Resize</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 docs-buttons d-none">
            <div class="btn-group">
        ...
        <div class="col-md-6 docs-toggles">
            ...
            <div class="btn-group d-flex flex-nowrap" data-toggle="buttons">
                ...
                <label class="btn btn-primary">
                    <input type="radio" class="sr-only" id="aspectRatio5" name="aspectRatio" value="1.91">
                    <span class="docs-tooltip" data-toggle="tooltip" data-animation="false" title="1.91 / 1">1.91 / 1</span>
                </label>
            </div>


            <div class="btn-group d-none" data-toggle="buttons">
                <!--<div class="btn-group d-flex flex-nowrap" data-toggle="buttons">-->
            ...
            <div class="dropdown dropup docs-options  d-none">
...
<script>
    var parentWindow = (!window.frameElement && window.dialogArguments) || opener || parent || top;
    document.addEventListener("DOMContentLoaded", function(event) {
        document.getElementById("image").src = settings.cdnUrl + parentWindow.cropImage;
        $('.submit-crop').click(function () {
            admin.params.image = parentWindow.cropImage;
            admin.params.dataX = $('#dataX').val();
            admin.params.dataY = $('#dataY').val();
            admin.params.dataHeight = $('#dataHeight').val();
            admin.params.dataWidth = $('#dataWidth').val();
            admin.params.dataRotate = $('#dataRotate').val();
            admin.params.dataScaleX = $('#dataScaleX').val();
            admin.params.dataScaleY = $('#dataScaleY').val();
            admin.params.dataResize = ($(this).attr('data-role') == 'resize') ? true : false;
            admin.params.keepAspectRatio = document.getElementById("keep-aspect-ratio").checked;
            admin.params.allowUpscaling = document.getElementById("allow-upscaling").checked;

            admin.extraUrl = '/upload/crop';
            admin.submit();
        });
    });
</script>
...
@push('stylesheet')
    ...
    <link href="{{asset('libs/jquery-cropper/main.css')}}" rel="stylesheet">
@endpush

@push('scripts')
    <script src="{{asset('libs/cropperjs/cropper.min.js')}}"></script>
    <script src="{{asset('libs/jquery-cropper/jquery-cropper.min.js')}}"></script>
    <script src="{{asset('libs/jquery-cropper/main.js?v='.config('versions.js'))}}"></script>
@endpush
